...
module.exports = {
    ...
    async update(request, response){
        ...
        try {
            ...
            return response.status(200).json({message: "Video updated succesfully"});
        } catch (error) {
            response.status(500).json({error: err.message});
        }
    },
    ...
    async delete(request, response){
        ...
        try {
            ...
            return response.status(200).json({message: "Video deleted succesfully"});
        } catch (err) {
    ...
    async updateLike(request, response){
        ...
        try {
            await response.video.save();
            return response.status(200).json({message: `Video ${response.video.liked ? "liked" : "unliked"} successfully saved`});
        } catch (error) {
